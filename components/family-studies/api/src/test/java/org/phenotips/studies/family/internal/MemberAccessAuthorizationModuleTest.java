...
/**
 * Tests for the {@link MemberAccessAuthorizationModule member granted access} {@link AuthorizationModule} component.
 *
 * @version $Id$
 */
public class MemberAccessAuthorizationModuleTest
{
    @Rule
    public final MockitoComponentMockingRule<AuthorizationModule> mocker =
        new MockitoComponentMockingRule<>(MemberAccessAuthorizationModule.class);
